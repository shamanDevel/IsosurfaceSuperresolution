...
parser.add_argument('--inputPathShaded', type=str, help="path for the shaded data")
parser.add_argument('--inputPathUnshaded', type=str, help="path for the unshaded data")
...
parser.add_argument('--initialImage', type=str, default='input', help="""
...
parser.add_argument('--lossAO', type=float, default=1.0, help="""
Strength of ambient occlusion in the loss function. Default=1
""")
parser.add_argument('--lossAmbient', type=float, default=0.1, help="""
Strength of the ambient light color in the loss function's shading. Default=0.1
""")
parser.add_argument('--lossDiffuse', type=float, default=0.1, help="""
Strength of the diffuse light color in the loss function's shading. Default=1.0
""")
parser.add_argument('--lossSpecular', type=float, default=0.0, help="""
...
parser.add_argument('--logdir', type=str, default='D:/VolumeSuperResolution/logdir_unshaded', help='directory for tensorboard logs')
parser.add_argument('--modeldir', type=str, default='D:/VolumeSuperResolution/modeldir_unshaded', help='Output directory for the checkpoints')
